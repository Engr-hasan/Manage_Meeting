...
//                    dd($getSequence);
                ...
                <a href="#" class="btn btn-{{$getSequence == 2?'success':'info'}}"
                       style="{{$getSequence == 2?'background-color:#358e35;':'background-color:#9dc8e2;color: #fff;'}} cursor: not-allowed">Agenda</a>
                <a href="#" class="btn btn-{{$getSequence == 3?'success':'info'}}"
                   style="{{$getSequence == 3?'background-color:#358e35;':'background-color:#9dc8e2;color: #fff;'}} cursor: not-allowed">Committee</a>
                ...
                <a href="#" class="btn btn-{{$getSequence == 20?'success':'info'}}"
                   style="{{$getSequence == 20?'background-color:#358e35;':'background-color:#9dc8e2;color: #fff;'}} cursor: not-allowed">Process addition</a>
