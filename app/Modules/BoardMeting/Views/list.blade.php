    ...
    <div class="col-lg-12">
        <div class="panel panel-info" style="">
            <div class="panel-heading">
                <div class="row">
                    <div class="col-lg-6">
                        <h5><i class="fa fa-list"></i>  <b><span class="list_name"></span></b> </h5>
                    </div>
                    <div class="col-lg-6">
                    </div>
                </div>
                    ...
                    <div class="" id="statuswiseAppsDiv">
                        ...
                        <div class="statusBox">
                            <div class="panel panel-success statusBox-inner" style="border-color: #347ab6">
                                <a data-toggle="tab" href="#list_all_meeting" class="statusWiseList" data-id="10,1" style="background: #008000" id="showSubmitted">
                                    <div class="panel-heading" style="background:#347ab6;color: white; padding: 5px !important; alignment-adjust: central;height: 100%" title="Submitted">

                                        <div class="row">
                                            <div class="col-xs-12 text-center">
                                                <div class="h3" style="margin-top:0;margin-bottom:0;font-size:16px;" id="Submitted">
                                                 &nbsp;
                                                </div>
                                            </div>
                                        </div>
                        ...
                        <div class="statusBox">
                            <div class="panel panel-success statusBox-inner" style="border-color: #5cb85c">
                                <a data-toggle="tab" href="#list_accomplished_meeting" class="statusWiseList" data-id="10,1" style="background: #008000" id="showAccomplished">
                                    <div class="panel-heading" style="background:#5cb85c;color: white; padding: 5px !important; alignment-adjust: central;height: 100%" title="Submitted">
                ...
                <div class="nav-tabs-custom" style="margin-top: 15px;padding: 0px 5px;">
                    <ul class="nav nav-tabs">
                        <li id="tab1" class="active">
                            <a data-toggle="tab" href="#list_all_meeting" class="mydesk" aria-expanded="true">
                                <b>Initiated List</b>
                            </a>
                        </li>
                        ...
                        <li id="tab2" class="">
                            <a data-toggle="tab" href="#list_accomplished_meeting" aria-expanded="false">
                                <b>Accomplished List</b>
                            </a>
                        </li>
                    ...
                    <div id="reyad" class="tab-content">
                        <div id="list_all_meeting" class="tab-pane active" style="margin-top: 20px">
                    ...
                    <span class="col-md-3 col-md-offset-5"
                          style="color: gray; font-weight: bold">Today's Date: {{date("d-M-Y")}}</span>
                                    ...
                                    <div class="table-responsive">
                                        <table id="list" class="table table-striped table-bordered dt-responsive " cellspacing="0"
                                            ...
                                            <thead>
                                            <tr>
                                                <th style="font-size: 13px">{!! trans('messages.basic_info_of_meeting') !!}</th>
                        ...
                        <div id="list_accomplished_meeting" class="tab-pane" style="margin-top: 20px">
                            <div class="panel-panel-info">
                                <div id="listOfProcess" class="panel panel-info">
...
@section('footer-script')
    ...
    <script>
        $(document).ready(function () {
            $('#showSubmitted').on('click',function () {
                $('#tab2').removeClass('active');
                $('#tab1').addClass('active');
            });

            $('#showAccomplished').on('click',function () {
