                                    ...
                                    <div class="form-group" style=" ">
                                        <div class="row">
                                            <div class="col-md-6">
                                                ...
                                                <div class="col-md-7">
                                                    {!! Form::text('name_and_designation',$appInfo->name, ['maxlength'=>'150',
                                                    'class' => 'form-control input-sm  required']) !!}
                                                    {!! $errors->first('name_and_designation','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                {!! Form::label('name_and_designation','Designation Of The Card Holder :',['class'=>'col-md-5 required-star']) !!}
                                                <div class="col-md-7">
                                                    {!! Form::text('designation',$appInfo->Name_and_designation, ['maxlength'=>'150',
                                                    'class' => 'form-control input-sm  required']) !!}
                                                    {!! $errors->first('name_and_designation','<span class="help-block">:message</span>') !!}
                                                </div>
                                            </div>
