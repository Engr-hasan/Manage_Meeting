...
{{--second section--}}
    ...
    <div style="page-break-after:always;">
        ...
        <?php
        $notblinfo =\App\Libraries\CommonFunction::getNotableInfo($appInfo->id);
        $activities=\App\Libraries\CommonFunction::getAcitvites($appInfo->id);
        $resource =\App\Libraries\CommonFunction::getResource($appInfo->id);
        $efficiency = \App\Libraries\CommonFunction::getEfficiency($appInfo->id);
        $newmember = \App\Libraries\CommonFunction::getNewMember($appInfo->id);
        $nextmonthpl =\App\Libraries\CommonFunction::getNextMOnthPlan($appInfo->id);
        $previousmonthininitiative =\App\Libraries\CommonFunction::getPreviousInitiative($appInfo->company_id,$appInfo->process_created);
        $notablework =\App\Libraries\CommonFunction::getNotableWork($appInfo->id);
