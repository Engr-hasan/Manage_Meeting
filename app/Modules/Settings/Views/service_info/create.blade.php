    ...
    <div class="col-lg-12">
        ...
        <div class="panel panel-primary">
            <div class="panel-heading">
                <b>{!! trans('messages.create_service') !!}</b>
            </div>
            <!-- /.panel-heading -->
            <div class="panel-body">
                <div class="col-lg-8">
                    {!! Form::open(array('url' => 'settings/service-details-save', 'method' => 'post','id'=>'reg_form1')) !!}
                    <div class="form-group col-md-12 {{$errors->has('title') ? 'has-error' : ''}}">
                        {!! Form::label('title', 'Title', ['class' => 'col-md-3 required-star']) !!}
                        <div class="col-md-9">
                            {!! Form::text('title', '', $attributes = array('class'=>'form-control required bnEng',
                    ...
                    <div class="form-group col-md-12 {{$errors->has('description') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::textarea('description', '', ['class'=>'wysihtml5-editor bnEng form-control required', 'size' => "10x9"]) !!}
                            {!! $errors->first('description','<span class="help-block">:message</span>') !!}
                        </div>
                    </div>
                    <div class="form-group col-md-12 {{$errors->has('login_page_details') ? 'has-error' : ''}}">
                        {!! Form::label('Login Page Details','Login Page Details: ',['class'=>'col-md-3 ']) !!}
                        <div class="col-md-9">
                            {!! Form::textarea('login_page_details', '', ['class'=>'wysihtml5-editor bnEng form-control', 'size' => "10x9"]) !!}
                    ...
                    <div class="form-group col-md-12 {{$errors->has('terms_and_conditions') ? 'has-error' : ''}}">
                        ...
                        <div class="col-md-9">
                            {!! Form::text('terms_and_conditions', '', $attributes = array('class'=>'form-control required bnEng',
                    ...
                    <div class="form-group col-md-12">
                        <div class="col-md-3">
                            <a href="{{ url('/settings/service-info') }}" class="btn btn-sm btn-default"><i class="fa fa-close"></i> Close</a>
                        </div>
                        <div class="col-md-9">
