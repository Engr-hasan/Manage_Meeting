    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
                ...
                <div class="col-md-7">
                    ...
                    <div style="position:relative;">
                        <img id="companyLogoViewer" style="width:110px;height:70px; position:absolute;top:-56px;right:0px;border:1px solid #ddd;padding:2px;background:#a1a1a1;"
                             src="{{ (!empty($data->slider_image)? url($data->slider_image) : '') }}" alt="">
                    </div>
                </div>
            </div>

            <div class="form-group col-md-8 {{$errors->has('slider_title') ? 'has-error' : ''}}">
                {!! Form::label('slider_title','Title: ',['class'=>'col-md-3']) !!}
                <div class="col-md-7">
                    {!! Form::text('slider_title',  $data->slider_title, ['class'=>'form-control bnEng', 'size' => "10x5"]) !!}
            ...
            <div class="form-group col-md-12 {{$errors->has('slider_url') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::text('slider_url',  $data->slider_url, ['class'=>'form-control bnEng']) !!}
            ...
            <div class="form-group col-md-12 {{$errors->has('slider_type') ? 'has-error' : ''}}">
                ...
                <div class="col-md-9">
                    {!! Form::select('slider_type', ['0' => 'image', '1' => 'DOD'], $data->slider_type,['class' => 'form-control input-sm','placeholder'=>'Select One','id'=>'attachment_type']) !!}
                    {!! $errors->first('type_of_company','<span class="help-block">:message</span>') !!}
                </div>
            </div>


            {{--<div class="form-group col-md-8 {{$errors->has('slider_interval') ? 'has-error' : ''}}">--}}
                {{--{!! Form::label('slider_interval','Slider Interval: ',['class'=>'col-md-3']) !!}--}}
                {{--<div class="col-md-7">--}}
                    {{--{!! Form::number('slider_interval',  $data->slider_interval, ['class'=>'form-control bnEng', 'size' => "10x5"]) !!}--}}
